...
def preprocess(data, degree, **kwargs):
    ...
    for i in range(num_pair):
        ...
        if gravity_type > 0:
            ...
            paths_edge_types, paths_type, paths_weight, paths_degrees, paths_gravity = process_paths(paths, G, G_inv, G_undirected, node_degree, num_edge_type, directed)
            paths_edge_types_inv, paths_type_inv, paths_weight_inv, paths_degrees_inv, paths_gravity_inv = process_paths(paths_inv, G, G_inv, G_undirected, node_degree, num_edge_type, directed)
